...
const GithubStartsButton = () => {
  return (
    <a
      ...
      tabIndex={0}
      className="focus-visible:outline-primary group/github-stars flex items-center gap-1.5 bg-white px-2.5 py-2.5 focus-within:outline-offset-2 focus-visible:outline-1 dark:bg-white/10"
    >
